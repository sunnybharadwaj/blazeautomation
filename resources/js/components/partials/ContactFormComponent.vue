                                ...
                                <div class="max-w-3xl mx-auto">
                                    ...
                                    <div class="mx-auto min-w-full">
                                                ...
                                                <div class="">
                                                    <div class="">
                                                        <div class="field">
                                                            ...
                                                            <select placeholder="Country Code" class="ui search dropdown" required v-model="code"  name="code" type="number">
                                        ...
                                        <div :class="{ 'error': $v.email.$error , 'field': true}">
                                            ...
                                            <input required v-model="email" id="email" name="email" type="email"
