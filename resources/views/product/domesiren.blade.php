            ...
            <div class="container">
                <div class="flex flex-wrap">
                    ...
                    <div class="w-full lg:w-7/12 product-details">
                        ...
                        <h3 class="h4">B.One’s Z-Wave based wireless dome siren with strobe light helps alert owners in case of a security breach or a safety concern.</h3>
                        ...
                        <div v-if="thisProduct.benefits.length">
                            ...
                            <div>
                                <ul>
                                    ...
                                    <li class="benefit point">
                                        <div class="flex"><span>5</span>.&nbsp;<span>Supports OTA firmware updates.</span>
                                        </div>
                                    </li>
                            </ul>
                        </div>
